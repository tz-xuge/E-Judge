...
rfc_random.fit(x_train_balanced,y_train_balanced) #使用训练数据集训练随机森林模型
print('best:', rfc_random.best_params_)
y_pred = rfc_random.predict(x_test) #使用分类器预测测试集的类别
# importances = rfc_random.feature_importances_ # 计算特征重要性
...
#
# # 绘制学习曲线
# train_sizes, train_scores, test_scores = learning_curve(rfc, x, y, cv=5)
# plt.figure(figsize=(10, 6))
